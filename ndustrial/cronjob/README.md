...
| `suspend`                    | If `true`, the CronJob controller will not create new Jobs for this schedule. Existing in-flight Jobs are unaffected. Useful for temporarily halting a tenant without removing the release.                                                                                                                                                                                                                                                                                                                                                                               | `false`     |
