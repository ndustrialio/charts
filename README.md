...
This repository hosts the official **[ndustrial.io](https://ndustrial.io) Helm Charts** for deploying to [Kubernetes](https://kubernetes.io/)
...
Upon successful review, someone will give the PR a **LGTM** (_looks good to me_) in the review thread.
Three **LGTM** are needed to get the PR approved and merged.
